...
typedef struct GParam {
	...
	int d_N_defect_levels;  // number of defect levels
	int d_N_replica_pt;		// numbers of replica used in parallel tempering
	int **d_L_defect;	// d_L_defect[i][dir] is the size of the i-th level of the defect in direction dir
	double *d_defect_beta; // d_defect_beta[n] is beta for the n-th replica on the lowest level of the defect
